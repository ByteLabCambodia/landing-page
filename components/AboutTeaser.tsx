      ...
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <Reveal>
          ...
          >
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 font-display text-sm font-semibold whitespace-nowrap text-white transition-colors group-hover:bg-primary-deep">
              {t.about.teaser.cta}
